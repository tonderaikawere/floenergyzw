...
import { TrendingUp, ShieldCheck, Flame, Fuel, Droplet, ChevronDown } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center w-full">
            <button
              ...
              className="hidden lg:flex items-center space-x-2 bg-flo-gold text-flo-dark font-extrabold text-xs uppercase px-3 py-1.5 rounded-lg shrink-0 mr-6 shadow hover:brightness-105 transition"
            >
              <TrendingUp className="w-4 h-4" />
              <span>Today's Rates</span>
              <ChevronDown className={`w-3.5 h-3.5 transition-transform ${showTrend ? 'rotate-180' : ''}`} />
            </button>
